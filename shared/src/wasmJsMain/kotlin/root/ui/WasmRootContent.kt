...
import navigation.ui.WasmNavContent
...
@Composable
fun WasmRootContent(component: WebDesktopRootComponent, modifier: Modifier = Modifier) {
...
//@Preview
@Composable
internal fun WasmRootContentPreview() {
    WasmRootContent(PreviewWebDesktopRootComponent())
}
